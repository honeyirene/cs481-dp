...
fig_acc.update_layout(yaxis_title='g',
...
fig_bvp.update_layout(yaxis_title='PPG',
    margin=dict(l=1,r=1,t=1,b=1),
    height=100,
    legend_font_size=30)
...
fig_hr.update_layout(yaxis_title='Heart Rate',
    margin=dict(l=1,r=1,t=1,b=1),
    height=100,
    legend_font_size=30)
...
fig_ibi.update_layout(yaxis_title='IBI',
    margin=dict(l=1,r=1,t=1,b=1),
    height=100,
    legend_font_size=40)

fig_temp = go.Figure()
fig_temp.add_trace(go.Scatter(y=data_temp, mode='lines',name='Temperature',showlegend=True))
...
fig_att_med.update_layout(yaxis_title='attention & meditation',
    margin=dict(l=1,r=1,t=1,b=1),
    height=100,
    legend_font_size=10)

fig_audio = go.Figure()
fig_audio.add_trace(go.Scatter(y=data_audio, mode='lines', name='audio',showlegend=True))
fig_audio.update_layout(yaxis_title='audio',
    margin=dict(l=1,r=1,t=1,b=1),
    height=100,
    legend_font_size=20)
#######################################################################################
    ...
    children=[
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(children = [
                            ...
                            html.Div(dcc.RangeSlider(id='time_slider', min=0, max=600, marks=None, value=[0, 600],
        ...
        html.Div(
            ...
            [dbc.Accordion(
                ...
                always_open=True,
                active_item=['acc','bvp','eda','hr', 'ibi', 'temp', 'a&m', 'bw', 'audio'],
            )]
        )
            ])
...
def update_plots(active_range):
    for fig in [fig_acc, fig_bvp, fig_eda, fig_hr, fig_ibi, fig_temp, fig_att_med, fig_bw, fig_audio]:
        fig.update_layout(xaxis=dict(range=active_range))
    return fig_acc, fig_bvp, fig_eda, fig_hr, fig_ibi, fig_temp, fig_att_med, fig_bw, fig_audio
