...
##################################################
tempTraceData = GraphTraceDataModel("aasdf", [1, 2, 3, 4, 5, 6])
tempPlotData = GraphPlotDataModel("asdf", [tempTraceData])
temp = ViewGraphComponent().getFC([tempPlotData, tempPlotData, tempPlotData])
