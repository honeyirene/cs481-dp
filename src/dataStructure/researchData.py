...
class ResearchDataFactory:
    ...
    def __init__(self):
        ...
        traceData_ext_cheerful = GraphTraceDataModel("cheerful", data_ext_stress_cheerful)
        ...
        traceData_ext_confusion = GraphTraceDataModel("confusion", data_ext_cBROMP_confusion)
        traceData_ext_delight = GraphTraceDataModel("delight", data_ext_cBROMP_delight)
        traceData_ext_concentration = GraphTraceDataModel("concentration", data_ext_cBROMP_concentration)
        traceData_ext_frustration = GraphTraceDataModel("frustration", data_ext_cBROMP_frustration)
        traceData_ext_surprise = GraphTraceDataModel("surprise", data_ext_cBROMP_surprise)
        traceData_ext_none_1 = GraphTraceDataModel("commonly used BROMP none", data_ext_cBROMP_none_1)
        traceData_ext_confrustion = GraphTraceDataModel("confrustion", data_ext_lcBROMP_confrustion)
        traceData_ext_contempt = GraphTraceDataModel("contempt", data_ext_lcBROMP_contempt)
        traceData_ext_dejection = GraphTraceDataModel("dejection", data_ext_lcBROMP_dejection)
        ...
        traceData_ext_none_2 = GraphTraceDataModel("less commonly used BROMP none", data_ext_lcBROMP_none_2)
        ...
        traceData_pnr_cheerful = GraphTraceDataModel("cheerful", data_pnr_stress_cheerful)
        ...
        traceData_pnr_confusion = GraphTraceDataModel("confusion", data_pnr_cBROMP_confusion)
        traceData_pnr_delight = GraphTraceDataModel("delight", data_pnr_cBROMP_delight)
        traceData_pnr_concentration = GraphTraceDataModel("concentration", data_pnr_cBROMP_concentration)
        traceData_pnr_frustration = GraphTraceDataModel("frustration", data_pnr_cBROMP_frustration)
        traceData_pnr_surprise = GraphTraceDataModel("surprise", data_pnr_cBROMP_surprise)
        traceData_pnr_none_1 = GraphTraceDataModel("commonly used BROMP none", data_pnr_cBROMP_none_1)
        traceData_pnr_confrustion = GraphTraceDataModel("confrustion", data_pnr_lcBROMP_confrustion)
        traceData_pnr_contempt = GraphTraceDataModel("contempt", data_pnr_lcBROMP_contempt)
        traceData_pnr_dejection = GraphTraceDataModel("dejection", data_pnr_lcBROMP_dejection)
        ...
        traceData_pnr_none_2 = GraphTraceDataModel("less commonly used BROMP none", data_pnr_lcBROMP_none_2)
        ...
        traceData_self_cheerful = GraphTraceDataModel("cheerful", data_self_stress_cheerful)
        ...
        traceData_self_nervous = GraphTraceDataModel("nervous", data_self_stress_nervous)
        traceData_self_sad = GraphTraceDataModel("sad", data_self_stress_sad)
        traceData_self_boredom = GraphTraceDataModel("boredom", data_self_cBROMP_boredom)
        traceData_self_confusion = GraphTraceDataModel("confusion", data_self_cBROMP_confusion)
        traceData_self_delight = GraphTraceDataModel("delight", data_self_cBROMP_delight)
        traceData_self_concentration = GraphTraceDataModel("concentration", data_self_cBROMP_concentration)
        traceData_self_frustration = GraphTraceDataModel("frustration", data_self_cBROMP_frustration)
        traceData_self_surprise = GraphTraceDataModel("surprise", data_self_cBROMP_surprise)
        traceData_self_none_1 = GraphTraceDataModel("commonly used BROMP none", data_self_cBROMP_none_1)
        traceData_self_confrustion = GraphTraceDataModel("confrustion", data_self_lcBROMP_confrustion)
        traceData_self_contempt = GraphTraceDataModel("contempt", data_self_lcBROMP_contempt)
        traceData_self_dejection = GraphTraceDataModel("dejection", data_self_lcBROMP_dejection)
        traceData_self_disgust = GraphTraceDataModel("disgust", data_self_lcBROMP_disgust)
        ...
        traceData_self_none_2 = GraphTraceDataModel("less commonly used BROMP none", data_self_lcBROMP_none_2)
